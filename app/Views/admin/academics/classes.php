        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= esc(substr($class['class_start'], 0, 5)) ?> - <?= esc(substr($class['class_end'], 0, 5)) ?></td>
                            ...
                            <form method="post" action="<?= site_url('admin/academics/classes/update/' . $class['class_id']) ?>">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <select name="course_id" class="form-select" required>
                                            ...
                                            <?php foreach ($courses as $course): ?>
                                                <option value="<?= esc($course['course_id']) ?>" <?= $course['course_id'] == $class['course_id'] ? 'selected' : '' ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="class_start" class="form-control" value="<?= esc($class['class_start']) ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label>End Time</label>
                                        <input type="text" name="class_end" class="form-control" value="<?= esc($class['class_end']) ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label>Room</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="faculty_id" class="form-select" required>
                                            ...
                                            <?php foreach ($instructors as $facultyId => $instructorName): ?>
                                                <option value="<?= esc($facultyId) ?>" <?= $facultyId == $class['faculty_id'] ? 'selected' : '' ?>>
                                                    <?= esc($instructorName) ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <form method="post" action="<?= site_url('admin/academics/classes/delete/' . $class['class_id']) ?>">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Are you sure you want to delete <strong><?= esc($class['course_description']) ?></strong> class?
                                </div>
                                <div class="modal-footer">
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="post" action="<?= site_url('admin/academics/classes/create') ?>">
                <?= csrf_field() ?>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="course_id" class="form-select" required>
                            <option value="">-- Select Course --</option>
                            <?php foreach ($courses as $course): ?>
                                <option value="<?= esc($course['course_id']) ?>"><?= esc($course['course_description']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label>Day</label>
                        <input type="text" name="class_day" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label>Start Time</label>
                        <input type="text" name="class_start" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label>End Time</label>
                        <input type="text" name="class_end" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label>Room</label>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="faculty_id" class="form-select" required>
                            <option value="">-- Select Instructor --</option>
                            <?php foreach ($instructors as $facultyId => $instructorName): ?>
                                <option value="<?= esc($facultyId) ?>"><?= esc($instructorName) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
