        ...
        <div class="card-body p-4">
            <form id="uploadGradesForm" action="<?= base_url('faculty/class/' . $class['class_id'] . '/grades/upload') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-end gap-3">
                    ...
                    <button type="submit" class="btn btn-outline-primary btn-sm mb-3" onclick="document.getElementById('grades_file').click();">
                        📤 Upload Grades
                    </button>
...
<script>
document.getElementById('grades_file').addEventListener('change', function () {
