        ...
        <ul class="sidebar-nav px-3">
            <li>
                <a href="<?= site_url('admin/academics/semesters') ?>"
                    class="<?= $current == 'semesters' ? 'active' : '' ?>" title="Semesters">
            ...
            <li>
                <a href="<?= site_url('admin/academics/subjects') ?>"
                    class="<?= $current == 'subjects' ? 'active' : '' ?>" title="Subjects">
            ...
            <li>
                <a href="<?= site_url('admin/academics/curriculums') ?>"
                    class="<?= $current == 'curriculums' ? 'active' : '' ?>" title="Curriculum">
            ...
            <li>
                <a href="<?= site_url('admin/academics/classes') ?>"
                    class="<?= $current == 'classes' ? 'active' : '' ?>" title="Classes">
