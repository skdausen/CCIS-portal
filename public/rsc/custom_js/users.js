    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        viewButtons.forEach(btn => {
            btn.addEventListener('click', function (e) {
                ...
                document.getElementById('detailFullname').textContent = ` ${user.fname} ${user.mname} ${user.lname}`;
                document.getElementById('detailSex').textContent = user.sex;
                document.getElementById('detailBirthday').textContent = user.birthday;
                document.getElementById('detailAddress').textContent = user.address;
                document.getElementById('detailContact').textContent = user.contact_number;
